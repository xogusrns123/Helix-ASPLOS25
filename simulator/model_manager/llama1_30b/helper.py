...
from simulator.event_simulator.utils import LLaMa1_30B_TOTAL_LAYERS, AVG_INPUT_LEN, AVG_OUTPUT_LEN, KV_CACHE_HWM


def llama30b_workload_ratio(target_machine_name: str, target_num_layers: int,
    ...
    :param num_machines_dict: a dict of {machine_name -> num of machines}
    ...
    round_trip_time = (LLaMa1_30B_TOTAL_LAYERS - target_num_layers) * (sum_of_time / sum_of_layers)
...
def llama30b_typical_statistics(workload_ratio: float, num_kv_cache_entries: int,
