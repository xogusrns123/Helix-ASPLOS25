...
class LLaMa30BonL4(ModelOnMachine):
    def __init__(self, num_machines_dict: Dict[str, int], typical_layers_dict: Dict[str, int],
        ...
        machine_name: str = "L4"
        max_num_layers: int = 11  # use 11.8GB for parameters
        # STEP 3/3: inference settings
        vllm_num_blocks_dict: Dict[int, int] = {
            1: 41191, 2: 19335, 3: 12050, 4: 8407, 5: 6221, 6: 4764, 7: 3724, 8: 2943, 9: 2336, 10: 1850,
            11: 1453
        ...
        decode_max_tokens_dict: Dict[int, int] = {
            1: 360, 2: 340, 3: 210, 4: 150, 5: 110, 6: 80, 7: 60, 8: 50, 9: 40, 10: 30, 11: 25
        }
        # ------------------------------------------------------ #
