...
class LLaMa30BonA100(ModelOnMachine):
    def __init__(self, num_machines_dict: Dict[str, int], typical_layers_dict: Dict[str, int],
        ...
        decode_max_tokens_dict: Dict[int, int] = {
            1: 360, 2: 360, 3: 360, 4: 320, 5: 250, 6: 200, 7: 160, 8: 140, 9: 120, 10: 100,
            11: 90, 12: 80, 13: 70, 14: 60, 15: 50, 16: 45, 17: 40, 18: 35
        }
        # ------------------------------------------------------ #
