...
class ExampleSmallT4(ModelOnMachine):
    def __init__(self) -> None:
        """
        This class stores the profiling results of running ExampleSmall on T4
        """
        # profiling results (for one single layer)
        self.prompt_bs2time: Dict[int, float] = {
            0: 0, 10: 200 * MilliSec, 20: 207 * MilliSec, 30: 207 * MilliSec, 40: 280 * MilliSec, 50: 360 * MilliSec
        }
        self.prompt_bs2vram: Dict[int, float] = {
            0: 0, 10: 10 * MB, 20: 20 * MB, 30: 30 * MB, 40: 40 * MB, 50: 50 * MB
        }
        self.decode_bs2time: Dict[int, float] = {
            0: 0, 1: 200 * MilliSec, 2: 207 * MilliSec, 3: 207 * MilliSec, 4: 280 * MilliSec, 5: 360 * MilliSec
        }
        ...
        # inference settings
        self.max_num_layers: int = 1
        self.num_layers_to_inference_settings: Dict[int, InferenceSettings] = {
            1: InferenceSettings(prompt_max_requests=2,
