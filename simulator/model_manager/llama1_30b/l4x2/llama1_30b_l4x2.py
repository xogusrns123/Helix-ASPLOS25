...
class LLaMa30BonL4x2(ModelOnMachine):
    def __init__(self, num_machines_dict: Dict[str, int], typical_layers_dict: Dict[str, int],
                 normalized_perf_dict: Dict[str, float]):
        """
        LLaMa1-30B + L4 24GB x 2
        """
        # --------------- Machine Dependent Data --------------- #
        # STEP 1/3: create prompt_bs2time.csv and decode_bs2time.csv
        # STEP 2/3: some basic parameters
        machine_name: str = "L4x2"
        max_num_layers: int = 22  # use 22.7GB for parameters
        # STEP 3/3: inference settings
        vllm_num_blocks_dict: Dict[int, int] = {
            1: 91244, 2: 44165, 3: 28600, 4: 20817, 5: 16147, 6: 13034, 7: 10811, 8: 9143, 9: 7845, 10: 6807,
            11: 5958, 12: 5251, 13: 4652, 14: 4139, 15: 3694, 16: 3305, 17: 2962, 18: 2657, 19: 2384, 20: 2138,
            21: 1916, 22: 1714
        ...
        decode_max_tokens_dict: Dict[int, int] = {
            1: 240, 2: 240, 3: 240, 4: 240, 5: 240, 6: 220, 7: 190, 8: 160, 9: 140, 10: 120,
            11: 100, 12: 90, 13: 80, 14: 70, 15: 60, 16: 60, 17: 50, 18: 45, 19: 40, 20: 35,
            21: 30, 22: 30
        }
        # ------------------------------------------------------ #
